...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  <motion.div
    ...
    } flex-center min-w-[170px] h-[700px] transition-[flex] duration-[0.7s] ease-out-flex cursor-pointer`}
  ...
  >
    ...
    {active !== id ? (
      <h3
        className="absolute font-semibold text-[18px] sm:text-[26px] text-white z-0
